...
- מקום עבודה חדש לתלמיד ללא שיבוץ → יוצר שיבוץ חדש (`work_number: 1`)
...
- נוצר שיבוץ חדש לכל תלמיד שנבחר, עם `work_number = max(work_number לאותו תלמיד באותו יום) + 1`
...
- מדלגים: היעדרות מאושרת (שיבוץ למקום אמיתי), תלמידים ללא שיבוץ, ומקומות עבודה אסורים
